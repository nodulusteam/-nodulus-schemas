...
angular.module("schemaForm").run(["$templateCache", "$http", function ($templateCache, $http) {
    ...
    $http.get("@nodulus/schemas/decorators/bootstrap/table.html").then(function (response) { $templateCache.put("decorators/bootstrap/table.html", response.data); });
    $http.get("@nodulus/schemas/decorators/ckeditor/ckeditor.html").then(function (response) { $templateCache.put("decorators/ckeditor/ckeditor.html", response.data); });
...
var tableControllerFunction = function (scope, $mdDialog, $uibModal, $Cache) {
    ...
    scope.add = function (form) {
        ...
        popups.push({
            ...
            templateUrl: '@nodulus/schemas/subform.html',
    ...
    scope.delete = function (row, form, collection, ev) {
        ...
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: "@nodulus/schemas/confirmDialog.html",
            scope: scope,
