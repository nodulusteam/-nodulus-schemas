      ...
      array: function (args) {
        ...
        if (items) {
          ...
          if (args.form.schema && args.form.schema.items &&
            ...
            args.form.schema.type.name !== 'object' &&
            args.form.schema.type.name !== 'array') {
      ...
      this.$get = function () {
        ...
        service.merge = function (schema, form, ignore, options, readonly, asyncTemplates) {
          ...
          return postProcessFn(form.map(function (obj) {
            ...
            //if (obj.type === 'checkbox' &&  angular.isUndefined(obj.default)) {
        ...
        link: function (scope, element, attrs) {
          ...
          scope.appendToArray = function () {
            ...
            if (scope.form && scope.form.schema && scope.form.schema.items) {
              ...
              if (items.type && items.type.name === 'object') {
                empty = {};
              ...
              } else if (items.type && items.type.name === 'array') {
                empty = [];
                if (!scope.options || scope.options.setSchemaDefaults !== false) {
